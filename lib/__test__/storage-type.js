...
exports.SignalProtocolStore = exports.isSignedPreKeyType = exports.isPreKeyType = exports.isKeyPairType = void 0;
...
class SignalProtocolStore {
    ...
    _direction) {
        ...
        return Promise.resolve(util.arrayBufferToString(identityKey) === util.arrayBufferToString(trusted));
    }
    loadPreKey(keyId) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    saveIdentity(identifier, identityKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const address = signal_protocol_address_1.SignalProtocolAddress.fromString(identifier);
            ...
            if (existing && util.arrayBufferToString(identityKey) !== util.arrayBufferToString(existing)) {
                return true;
            }
            else {
                return false;
